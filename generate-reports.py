...
# Script to generate a Maven site.
# This script assumes that git has been installed.
...
#     └── ...
#
# So only one "development" version of the documents is maintained, while documentation for all 
# tagged commits--assumed to be releases--is maintained on the gh-pages branch. 
# 
